...
describe('CurrentWeatherComponent', () => {
  ...
  it('should eagerly load currentWeather in Bethesda from weatherService', () => {
    ...
    expect(component.current.city).toEqual('Cypress')
    expect(component.current.temperature).toEqual(280.32)

    // Assert on DOM
    const debugEl = fixture.debugElement
    const titleEl: HTMLElement = debugEl.query(By.css('.mat-title')).nativeElement
    expect(titleEl.textContent).toContain('Cypress')
  })
})
...
//   it('should eagerly load currentWeather in Cypress from weatherService', () => {
//     // Arrange
//     weatherServiceMock.getCurrentWeather.and.returnValue(of(fakeWeather))
